                    ...
                    <tr>
                        <td>
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:0 0 16px 16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                                <!-- Header -->
                                <tr>
                                    <td style="background:linear-gradient(135deg,#4c1d95 0%,#7c3aed 50%,#a78bfa 100%);padding:40px 48px;text-align:center;">
                                ...
                                <tr>
                                    <td style="padding:24px 48px 40px;">
                                        <h1 style="margin:0 0 8px;color:#0c4a6e;font-size:24px;font-weight:700;text-align:center;">Signature Requested</h1>
                                        <p style="margin:0 0 24px;color:#64748b;font-size:15px;text-align:center;line-height:1.5;">
                                            <strong style="color:#0c4a6e;">{{ $requester->first_name }} {{ $requester->last_name }}</strong> has requested your signature on an affiliation agreement.
                                        </p>
                                            ...
                                            <tr>
                                                <td style="padding:20px;">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td style="padding:4px 0;color:#64748b;font-size:13px;font-weight:600;">University</td>
                                                            <td style="padding:4px 0;color:#0c4a6e;font-size:13px;text-align:right;">{{ $agreement->university->name }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding:4px 0;color:#64748b;font-size:13px;font-weight:600;">Clinical Site</td>
                                                            <td style="padding:4px 0;color:#0c4a6e;font-size:13px;text-align:right;">{{ $agreement->site->name }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="padding:4px 0;color:#64748b;font-size:13px;font-weight:600;">Your Role</td>
                                                            <td style="padding:4px 0;color:#0c4a6e;font-size:13px;text-align:right;">{{ ucfirst($signature->signer_role) }} Representative</td>
                                                        </tr>
                                                        @if($agreement->start_date)
                                                        <tr>
                                                            <td style="padding:4px 0;color:#64748b;font-size:13px;font-weight:600;">Period</td>
                                                            <td style="padding:4px 0;color:#0c4a6e;font-size:13px;text-align:right;">{{ $agreement->start_date->format('M j, Y') }}{{ $agreement->end_date ? ' – ' . $agreement->end_date->format('M j, Y') : '' }}</td>
                                                        </tr>
                                                        @endif
                                                    </table>
                                                </td>
                                        ...
                                        @if($signature->request_message)
                                        <!-- Personal Message -->
                                        <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,#faf5ff,#f3e8ff);border:1px solid #e9d5ff;border-left:4px solid #8b5cf6;border-radius:0 14px 14px 0;margin-bottom:24px;">
                                            <tr>
                                                <td style="padding:16px 20px;">
                                                    <p style="margin:0 0 6px;color:#6b21a8;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;">Message from {{ $requester->first_name }}</p>
                                                    <p style="margin:0;color:#475569;font-size:14px;line-height:1.6;white-space:pre-line;">{{ $signature->request_message }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                        @endif
                                        ...
                                        <p style="margin:0;color:#94a3b8;font-size:13px;text-align:center;line-height:1.5;">
                                            By signing, you confirm that you have authority to execute this agreement on behalf of your organization.
                                        </p>
                                    </td>
                                </tr>
