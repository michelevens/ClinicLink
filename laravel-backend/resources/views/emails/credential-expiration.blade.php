                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:0 0 16px 16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                                <tr>
                                    <td style="background:linear-gradient(135deg,#92400e 0%,#d97706 50%,#f59e0b 100%);padding:40px 48px;text-align:center;">
                                        ...
                                        <p style="margin:12px 0 0;color:rgba(255,255,255,0.8);font-size:13px;letter-spacing:2px;text-transform:uppercase;">Credential Alert</p>
                                    </td>
                                </tr>

                                <tr>
                                    <td style="text-align:center;padding:32px 48px 0;">
                                        <div style="display:inline-block;width:72px;height:72px;background:linear-gradient(135deg,#fef3c7,#fde68a);border-radius:50%;line-height:72px;font-size:36px;">&#9888;&#65039;</div>
                                    </td>
                                </tr>

                                <tr>
                                    <td style="padding:24px 48px 40px;">
                                        <h1 style="margin:0 0 8px;color:#0c4a6e;font-size:24px;font-weight:700;text-align:center;">Credentials Expiring Soon</h1>
                                        <p style="margin:0 0 24px;color:#64748b;font-size:15px;text-align:center;line-height:1.5;">Hi {{ $user->first_name }}, the following credentials need your attention:</p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e2e8f0;border-radius:14px;overflow:hidden;margin-bottom:24px;">
                                            <tr style="background-color:#f8fafc;">
                                                <td style="padding:10px 16px;font-size:13px;font-weight:700;color:#475569;border-bottom:1px solid #e2e8f0;">Credential</td>
                                            ...
                                            @php
                                                $daysLeft = (int) now()->diffInDays($credential->expiration_date, false);
                                            ...
                                            <tr>
                                                <td style="padding:12px 16px;font-size:14px;color:#1e293b;border-bottom:1px solid #f1f5f9;">
                                                    ...
                                                    <br><span style="font-size:12px;color:#94a3b8;">{{ ucfirst(str_replace('_', ' ', $credential->type)) }}</span>
                                                </td>
                                                <td style="padding:12px 16px;font-size:14px;color:{{ $color }};font-weight:700;text-align:right;border-bottom:1px solid #f1f5f9;">
                                                    {{ $credential->expiration_date->format('M j, Y') }}
                                        ...
                                        <p style="margin:0 0 28px;color:#475569;font-size:15px;line-height:1.6;text-align:center;">Please update or renew these credentials to maintain your compliance status.</p>

                                        <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                            <tr>
                                                <td style="background:linear-gradient(135deg,#0369a1,#0ea5e9);border-radius:12px;box-shadow:0 4px 12px rgba(14,165,233,0.3);">
                                                    <a href="{{ env('FRONTEND_URL', 'https://michelevens.github.io/ClinicLink') }}/settings" style="display:inline-block;padding:16px 36px;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;">Update Credentials</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
