                                ...
                                <tr>
                                    <td style="padding:24px 48px 40px;">
                                        ...
                                        <p style="margin:0 0 24px;color:#64748b;font-size:15px;text-align:center;line-height:1.5;">
                                            <strong style="color:#0c4a6e;">{{ $inviterName }}</strong> has invited you to join <strong style="color:#0c4a6e;">{{ $universityName }}</strong> as a student on ClinicLink.
                                        </p>
                                            ...
                                            <tr>
                                                <td style="padding:16px 20px;text-align:center;">
                                                    <p style="margin:0;color:#475569;font-size:14px;line-height:1.6;">
                                                        Click below to accept the invitation and join your university on ClinicLink. If you don't have an account yet, you'll be able to create one.
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
