                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:0 0 16px 16px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                                ...
                                <tr>
                                    <td style="padding:24px 48px 40px;">
                                        <h1 style="margin:0 0 8px;color:#0c4a6e;font-size:24px;font-weight:700;text-align:center;">Hour Log {{ $label }}</h1>
                                        <p style="margin:0 0 24px;color:#64748b;font-size:15px;text-align:center;line-height:1.5;">
                                            Hi {{ $hourLog->student->first_name }}, your hour log entry has been reviewed.
                                        </p>

                                        <!-- Details Card -->
                                        <table width="100%" cellpadding="0" cellspacing="0" style="{{ $cardBg }}border-radius:14px;margin-bottom:24px;">
                                            <tr>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,#fef2f2,#fee2e2);border-left:4px solid #ef4444;border-radius:0 14px 14px 0;margin-bottom:24px;">
                                            <tr>
                                                <td style="padding:16px 20px;">
                                                    <p style="margin:0 0 4px;color:#991b1b;font-size:13px;font-weight:700;">Reason for rejection:</p>
                                                    <p style="margin:0;color:#475569;font-size:14px;line-height:1.6;">{{ $hourLog->rejection_reason }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                        @endif
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                            <tr>
                                                <td style="background:linear-gradient(135deg,#0369a1,#0ea5e9);border-radius:12px;box-shadow:0 4px 12px rgba(14,165,233,0.3);">
                                                    <a href="{{ env('FRONTEND_URL', 'https://michelevens.github.io/ClinicLink') }}/hours" style="display:inline-block;padding:16px 36px;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;">View Hour Log</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
