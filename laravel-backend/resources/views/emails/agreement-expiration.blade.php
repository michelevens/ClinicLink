                                        ...
                                        <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                            <tr>
                                                <td style="background-color:#0369a1;border-radius:12px;">
                                                    <a href="{{ env('FRONTEND_URL', 'https://cliniclink.health') }}/agreements" style="display:inline-block;padding:16px 36px;color:#ffffff;text-decoration:none;font-size:15px;font-weight:700;">View Agreements</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
