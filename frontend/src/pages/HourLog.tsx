          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-stone-200 bg-stone-50">
                ...
                <th className="text-left px-6 py-3 text-xs font-medium text-stone-500 uppercase">Hours</th>
            ...
            <tbody className="divide-y divide-stone-100">
              {hours.map(entry => (
                <tr key={entry.id} className="hover:bg-stone-50 transition-colors">
                  ...
                  <td className="px-6 py-4 text-sm font-semibold text-stone-900">{entry.hoursWorked}h</td>
                  <td className="px-6 py-4"><Badge variant="default">{categoryLabels[entry.category]}</Badge></td>
                  <td className="px-6 py-4 text-sm text-stone-600 max-w-xs truncate">{entry.description}</td>
