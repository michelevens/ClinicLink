  ...
  return (
    <div className="min-h-screen bg-stone-50">
      ...
      <header className="relative overflow-hidden">
        ...
        <nav className="relative z-10 max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button variant="ghost" className="text-white hover:bg-white/10" onClick={() => navigate('/login')}>Sign In</Button>
            <Button variant="outline" className="border-white text-white hover:bg-white/10" onClick={() => navigate('/register')}>Register</Button>
          </div>
        </nav>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <Button size="lg" className="bg-white text-primary-600 hover:bg-white/90" onClick={() => navigate('/register')}>
              Get Started Free <ArrowRight className="w-5 h-5" />
            </Button>
            <Button size="lg" variant="outline" className="border-white/50 text-white hover:bg-white/10" onClick={() => navigate('/rotations')}>
              Browse Rotations
            </Button>
          </div>
        </div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-stone-900 mb-4">How ClinicLink Works</h2>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-stone-900 mb-4">Built For Everyone in Clinical Education</h2>
          </div>
      ...
      <section className="py-20 px-6 bg-stone-50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-stone-900 mb-4">Try It Now — No Sign Up Required</h2>
          <p className="text-lg text-stone-600 mb-10">Explore ClinicLink as any role with our demo accounts</p>
