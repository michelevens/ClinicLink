...
export const authApi = {
  register: (data: { first_name: string; last_name: string; email: string; username?: string; password: string; password_confirmation: string; role: string; university_id?: string; program_id?: string; site_id?: string; license_code?: string; npi_number?: string; affiliated_university_id?: string; affiliated_site_id?: string }) =>
